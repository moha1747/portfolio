...
import photoProfile from "@/assets/images/pfp1.png";
...
export function DefaultAppShell({ children }: { children: React.ReactNode }) {
  ...
  const handleContacts = () => {
    ...
    // make contacts' border blink for 3 times with green color
    ...
    >
        ...
        <div className="flex h-full w-full items-center justify-center bg-zinc-50 transition-colors duration-200 ease-in-out dark:bg-black dark:text-white">
          <div className="relative flex w-full max-w-7xl items-center justify-between px-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Link
                href={"/"}
                className="flex items-center justify-center gap-3 rounded-md p-2 transition-all duration-200 ease-in-out hover:bg-green-500/10 hover:ring-1 hover:ring-green-500"
              >

                <div className="font-semibold">Abbaas Mohamud</div>
              </Link>
            </div>
      ...
      <footer className="w-full bg-zinc-50 dark:bg-black dark:text-white">
        <Container className="mt-12 space-y-12 p-4">
          ...
          >
            <Link
              href={"mailto:abbaasmohamud@gmail.com"}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-2 duration-200 hover:text-green-500"
            >
              <IconMail size={40} />
              <div>abbaasmohamud@gmail.com</div>
            </Link>
            ...
            <Link
              href={"https://github.com/moha1747"}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-2 duration-200 hover:text-green-500"
            >
          ...
          <div className="flex flex-col items-center justify-center space-x-2 sm:flex-row">
            <div>© {currentYear} Abbaas Mohamud</div>
            <div>•</div>
            <div>
              Powered by{" "}
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="underline duration-200 hover:text-green-500"
              >
                Next.js
              </Link>{" "}
              and{" "}
